...
kv_v_podezde = floors * kv_on_floor
nice_podezd = num_kv // kv_v_podezde + 1 #ДОДУМАТЬ КОММЕНТАРИЙ 
...
nice_floor += 1                          # ДОДУМАТЬ КОММЕНТАРИЙ

print('Квартира', num_kv, 'находится на', nice_floor, 'этаже в', nice_podezd, 'подъезде')
